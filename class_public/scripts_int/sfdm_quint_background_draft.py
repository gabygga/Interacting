...
plt.semilogx(1/(1+backgroundQ['z']), (backgroundQ['(.)rho_b']+backgroundQ['(.)rho_sfdm_1'])/baCritQ, color='c',linestyle=':',alpha=0.6, label='$\Omega_{m}:m_{\phi}=10^{-24}\\rm{eV}, \lambda_{\phi}=10^4$')
#plt.semilogx(1/(1+backgroundQ['z']), (backgroundQ['(.)rho_b']+backgroundQ['(.)rho_cdm'])/baCritQ, color='g',linestyle='-.', label='$\Omega_{b}$')
#plt.semilogx(1/(1+backgroundQ1['z']), (backgroundQ1['(.)rho_g']+backgroundQ1['(.)rho_ncdm[0]'])/baCritQ1, color='r',linestyle='--', label='$\Omega_{g}$')
#plt.semilogx(1/(1+backgroundQ1['z']), (backgroundQ1['(.)rho_scf'])/baCritQ1, color='m',alpha=0.6,linestyle='-', label='$\Omega_{\psi}:\\lambda=12, A=0.004, B=22.66$')
#plt.semilogx(1/(1+backgroundQ1['z']), (backgroundQ1['(.)rho_b']+backgroundQ1['(.)rho_sfdm_1'])/baCritQ1, color='c',linestyle='-',alpha=0.6, label='$\Omega_{m}:m_{\phi}=10^{-22}\\rm{eV}, \lambda_{\phi}=10^4$')
...
plt.ylabel(r"$w$")
plt.tight_layout()
plt.legend(title='$\\beta=10^{-4}$')

# In[ ]:


plt.savefig('scripts_int/Plots/Omegas_beta.pdf')
