...
#
plt.semilogx(1/(1+backgroundQ2['z']),backgroundQ2['(.)rho_scf']/baCritQ2, color='c', label='$\Omega_{\phi}$')
...
#
plt.semilogx(1/(1+backgroundQ3['z']),backgroundQ3['(.)rho_scf']/baCritQ3, color='m', label='$\Omega_{\phi}$')
#plt.semilogx(1/(1+backgroundQ2['z']), (backgroundQ2['(.)rho_g']+backgroundQ2['(.)rho_ncdm[0]'])/baCritQ2, color='c', label='$\Omega_{g}$')
#plt.semilogx(1/(1+backgroundQ3['z']), (backgroundQ3['(.)rho_b']+backgroundQ3['(.)rho_cdm'])/baCritQ3,linestyle='--' ,color='g', label='$\Omega_{m}$')
#
plt.semilogx(1/(1+backgroundQ4['z']),backgroundQ4['(.)rho_scf']/baCritQ4, color='r', label='$\Omega_{\phi}$')
#plt.semilogx(1/(1+backgroundQ2['z']), (backgroundQ2['(.)rho_g']+backgroundQ2['(.)rho_ncdm[0]'])/baCritQ2, color='c', label='$\Omega_{g}$')
...
plt.tight_layout()
plt.legend(title='$\lambda=4, \\alpha=2, A=0.03, B=67.86, \phi_{ini}=22, \dot{\phi}_{ini}=0 $')

# In[ ]:


plt.savefig('scripts_int/Plots/AS_explo23.pdf')
