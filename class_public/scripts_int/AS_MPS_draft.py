...
plt.semilogx(kvec/h, np.array(pkMQ4)/np.array(pkM),color='m',linestyle='-', label='$\lambda=12, A=0.004, B=22.58$')
...
plt.savefig('scripts_int/Plots/AS_MPS_ratio.pdf', bbox_inches='tight', pad_inches=0.04)
