...
plt.semilogx(1/(1+backgroundQ4['z']),backgroundQ4['(.)p_scf']/backgroundQ4['(.)rho_scf'],color='m', label='$\omega_{\phi}$')
plt.semilogx(1/(1+backgroundQ4['z']),((1./3.)*backgroundQ4['(.)rho_g']+backgroundQ4['(.)p_ncdm[0]']+backgroundQ4['(.)p_scf'])/(backgroundQ4['(.)rho_scf']+backgroundQ4['(.)rho_g']+backgroundQ4['(.)rho_ncdm[0]']+backgroundQ4['(.)rho_b']+backgroundQ4['(.)rho_cdm']),color='b', label='$\omega_{eff}$')
plt.semilogx(1/(1+backgroundQ4['z']),1/2+(3/2)*((1./3.)*backgroundQ4['(.)rho_g']+backgroundQ4['(.)p_ncdm[0]']+backgroundQ4['(.)p_scf'])/(backgroundQ4['(.)rho_scf']+backgroundQ4['(.)rho_g']+backgroundQ4['(.)rho_ncdm[0]']+backgroundQ4['(.)rho_b']+backgroundQ4['(.)rho_cdm']),color='g',linestyle='-.', label='$q$')
...
plt.savefig('scripts/Plots/w_AS.pdf')
