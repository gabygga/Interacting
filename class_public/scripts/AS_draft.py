...
plt.semilogx(1/(1+backgroundQ4['z']),backgroundQ4['(.)rho_scf']/baCritQ4, color='m', label='$\Omega_{\phi}$')
plt.semilogx(1/(1+backgroundQ2['z']), (backgroundQ4['(.)rho_g']+backgroundQ4['(.)rho_ncdm[0]'])/baCritQ4, linestyle=':' , color='#0e0e44', label='$\Omega_{g}$')
plt.semilogx(1/(1+backgroundQ2['z']), (backgroundQ4['(.)rho_b']+backgroundQ4['(.)rho_cdm'])/baCritQ4,linestyle='--' ,color='#fdd55b', label='$\Omega_{m}$')
