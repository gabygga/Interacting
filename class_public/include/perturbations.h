...
struct perturbs
{
 ...
 int size_tensor_perturbation_data[_MAX_NUMBER_OF_K_FILES_]; /**< Array of sizes of tensor double pointers  */
  ...
  short has_source_delta_sfdm_1;  /**< do we need source for delta from scalar field dark matter? */
  /*Scalar Field Dark Matter 2*/
  short has_source_delta_sfdm_2;  /**< do we need source for delta from scalar field dark matter? */
  short has_source_delta_scf;  /**< do we need source for delta from scalar field? */
  short has_source_delta_int;  /**< Modification do we need source for delta int from scalar field? */
  ...
  /*Scalar Field Dark Matter 1*/
  short has_source_theta_sfdm_1;  /**< do we need source for theta of scalar field dark matter? */
  /*Scalar Field Dark Matter 2*/
  short has_source_theta_sfdm_2;  /**< do we need source for theta of scalar field dark matter? */
  ...
  /*Scalar Field Dark Matter 1*/
  int index_tp_delta_sfdm_1;  /**< index value for delta of scalar field dark matter */
  /*Scalar Field Dark Matter 2*/
  int index_tp_delta_sfdm_2;  /**< index value for delta of scalar field dark matter */
  int index_tp_delta_scf;  /**< index value for delta of scalar field */
  int index_tp_delta_int;  /**< Modification, index value for delta interaction of scalar field */
  ...
  /*Scalar Field Dark Matter 1*/
  int index_tp_theta_sfdm_1;  /**< index value for theta of scalar field dark matter */
  /*Scalar Field Dark Matter 2*/
  int index_tp_theta_sfdm_2;  /**< index value for theta of scalar field dark matter */
...
struct perturb_vector
{
  ...
  /*Scalar Field Dark Matter 1*/
  int index_pt_delta_sfdm_1;  /**< scalar field dark matter density contrast */
  int index_pt_delta1_sfdm_1;  /**< scalar field dark matter auxiliary density contrast */
  int index_pt_omega_sfdm_1;  /**< scalar field dark matter frequency */
  /*Scalar Field Dark Matter 2*/
  int index_pt_delta_sfdm_2;  /**< scalar field dark matter density contrast */
  int index_pt_delta1_sfdm_2;  /**< scalar field dark matter auxiliary density contrast */
  int index_pt_omega_sfdm_2;  /**< scalar field dark matter frequency */
  int index_pt_phi_scf;  /**< scalar field density */
  int index_pt_phi_prime_scf;  /**< scalar field velocity */
  int index_pt_delta_int; /*Modification*/
