...
struct background
{
  ...
  /*We are going to duplicate these variables for sfdm in order to have two scalar fields*/
  /*Scalar field dark matter 1*/
  double Omega0_sfdm_1;        /**< \f$ \Omega_{0 sfdm} \f$: scalar field dark matter */
  //int expo_sfdm_1;             /**< \f$ \expo_{0 sfdm} \f$: scalar field dark matter power potential*/
  short attractor_ic_sfdm_1;   /**< whether the scalar field dark matter has attractor initial conditions */
  double theta_ini_sfdm_1;       /**< \f$ \theta_sfdm(t_0) \f$: scalar field initial angular value */
  double y1_ini_sfdm_1;       /**< \f$ y1_sfdm(t_0) \f$: scalar field initial potential value */
  double alpha_ini_sfdm_1;       /**< \f$ alpha_sfdm(t_0) \f$: scalar field initial 0.5*log(Omega_ini) value */
  double Omega_ini_sfdm_1; /**< \f$ Omega_sfdm(t_0) \f$: scalar field initial density parameter */
  double * sfdm_parameters_1;  /**< list of parameters describing the scalar field dark matter potential */
  int sfdm_parameters_size_1;  /**< size of sfdm_parameters */
  int sfdm_tuning_index_1;     /**< index in sfdm_parameters used for tuning */

  /*Scalar field dark matter 2*/
  double Omega0_sfdm_2;        /**< \f$ \Omega_{0 sfdm} \f$: scalar field dark matter */
  //int expo_sfdm_2;             /**< \f$ \expo_{0 sfdm} \f$: scalar field dark matter power potential*/
  short attractor_ic_sfdm_2;   /**< whether the scalar field dark matter has attractor initial conditions */
  double theta_ini_sfdm_2;       /**< \f$ \theta_sfdm(t_0) \f$: scalar field initial angular value */
  double y1_ini_sfdm_2;       /**< \f$ y1_sfdm(t_0) \f$: scalar field initial potential value */
  double alpha_ini_sfdm_2;       /**< \f$ alpha_sfdm(t_0) \f$: scalar field initial 0.5*log(Omega_ini) value */
  double Omega_ini_sfdm_2; /**< \f$ Omega_sfdm(t_0) \f$: scalar field initial density parameter */
  double * sfdm_parameters_2;  /**< list of parameters describing the scalar field dark matter potential */
  int sfdm_parameters_size_2;  /**< size of sfdm_parameters */
  int sfdm_tuning_index_2;     /**< index in sfdm_parameters used for tuning */
  ...
  /*Scalar field dark matter 1*/
  int index_bg_theta_sfdm_1;       /**< scalar field dark matter angular variable */
  int index_bg_y1_sfdm_1; /**< scalar field dark matter potential variable */
  int index_bg_y2_sfdm_1; /*SFDM y2 auxiliar variable*/
  int index_bg_alpha_sfdm_1;         /**< scalar field dark matter 0.5*log(density parameter) */
  int index_bg_rho_sfdm_1;       /**< scalar field dark matter energy density */
  int index_bg_p_sfdm_1;         /**< scalar field dark matter pressure */

  /*Scalar field dark matter 2*/
  int index_bg_theta_sfdm_2;       /**< scalar field dark matter angular variable */
  int index_bg_y1_sfdm_2; /**< scalar field dark matter potential variable */
  int index_bg_y2_sfdm_2; /*SFDM y2 auxiliar variable*/
  int index_bg_alpha_sfdm_2;         /**< scalar field dark matter 0.5*log(density parameter) */
  int index_bg_rho_sfdm_2;       /**< scalar field dark matter energy density */
  int index_bg_p_sfdm_2;         /**< scalar field dark matter pressure */

  /*This total equation of state will be used for both scalar fields (sfdm)*/
  int index_bg_w_tot_1;         /**< total equation of state */
  int index_bg_w_tot_2;         /**< total equation of state */
  ...
  /*Scalar field dark matter 1*/
  int index_bi_theta_sfdm_1;       /**< {B} scalar field dark matter angular variable */
  int index_bi_y1_sfdm_1;       /**< {B} scalar field dark matter potential variable */
  int index_bi_alpha_sfdm_1; /**< {B} scalar field dark matter 0.5*log(density parameter) */
  /*Scalar field dark matter 2*/
  int index_bi_theta_sfdm_2;       /**< {B} scalar field dark matter angular variable */
  int index_bi_y1_sfdm_2;       /**< {B} scalar field dark matter potential variable */
  int index_bi_alpha_sfdm_2; /**< {B} scalar field dark matter 0.5*log(density parameter) */
...
extern "C" {
  ...
  double y2_sfdm(struct background *pba, double Omega_sfdm, double theta_sfdm, double y1_sfdm, double lambda);
